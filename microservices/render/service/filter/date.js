 ...
 * использование {{ user.created | date() }} user.created - дата которую фрматируем в нужный формат, по умолчанию используется 'DD MMMM YYYY h:mm. Так же по умолчанию русская локализация.
